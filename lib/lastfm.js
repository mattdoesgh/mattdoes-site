 ...
 * and reads the total playcount from the response's `@attr.total` (the
 * build-time snapshot gets its playcount from `user.getinfo` instead —
 * a deliberate split, see {@link decodePlaycount}).
 *
