...
function copyTimelineControlsBundle(distDir) {
 ...
 *    malformed link.
 *
 * Listening/scrobble data is not a feed kind (see `feedEntries` above), so
 * the feed carries only articles and thoughts.
 *
