...
<main class="page" id="main">
  <aside class="side-left" aria-label="page meta">
    <div class="ident">
      ...
      <div class="bio">How this site is put together. Obsidian vault → Node build → React-rendered static HTML. R2 holds media; two thin Workers — listening + geo — handle the live bits. KV caches both upstreams so request paths never block.</div>
    </div>
  ...
  <aside class="side-right" aria-label="related">
    ...
    <div class="group">
      ...
      <ul>
        ...
        <li><span>React + TS</span><span class="meta">pages</span></li>
        <li><span>marked + gray-matter</span><span class="meta">md</span></li>
        <li><span>shiki</span><span class="meta">code hl</span></li>
        <li><span>marked-footnote</span><span class="meta">md ext</span></li>
